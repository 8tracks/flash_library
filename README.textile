...
The library provides code to play both MP3 files and AAC files using a common interface.
...
It can then be used to create a handle to an audio file:
...
Then you can used the interface to control playback:
